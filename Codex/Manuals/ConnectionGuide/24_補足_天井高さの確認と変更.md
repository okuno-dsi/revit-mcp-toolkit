...
**実行コマンド:**
```bash
python Python/Manuals/Scripts/send_revit_command_durable.py --port 5210 --command set_ceiling_parameter --params "{\"elementId\": 666, \"paramName\": \"オフセット(基準レベル)\", \"value\": 3200.0}"
```
