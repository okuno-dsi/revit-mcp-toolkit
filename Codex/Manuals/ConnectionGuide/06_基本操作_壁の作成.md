...
```bash
del %USERPROFILE%\Documents\VS2022\Ver101\GeminiCLI\temp_create_4_walls_v2.py \
    %USERPROFILE%\Documents\VS2022\Ver101\GeminiCLI\created_4_walls_v2.json \
    %USERPROFILE%\Documents\VS2022\Ver101\GeminiCLI\temp_create_walls_level_to_level.py \
    %USERPROFILE%\Documents\VS2022\Ver101\GeminiCLI\created_walls_level_to_level.json \
    %USERPROFILE%\Documents\VS2022\Ver101\GeminiCLI\temp_offset_walls_level_to_level.py \
    %USERPROFILE%\Documents\VS2022\Ver101\GeminiCLI\temp_create_dimension_between_walls_level_to_level.py
```
