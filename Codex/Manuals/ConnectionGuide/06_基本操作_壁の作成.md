...
```bash
python Python/Manuals/Scripts/send_revit_command_durable.py --port 5210 --command element.create_flush_walls --params "{\"newWallTypeNameOrId\":\"(内壁)W5\",\"sideMode\":\"ByGlobalDirection\",\"globalDirection\":[0,-1,0],\"sourcePlane\":\"FinishFace\",\"newPlane\":\"FinishFace\",\"newExteriorMode\":\"MatchSourceExterior\",\"miterJoints\":true,\"copyVerticalConstraints\":true}"
```
...
```bash
python Python/Manuals/Scripts/send_revit_command_durable.py --port 5210 --command room.apply_finish_wall_type_on_room_boundary --params "{\"fromSelection\":true,\"newWallTypeNameOrId\":\"(内壁)W5\",\"onlyRcCore\":true,\"coreMaterialNameContains\":\"*コンクリート\",\"boundaryLocation\":\"Finish\",\"skipExisting\":true,\"joinEnds\":true}"
```
