...
```bash
del %USERPROFILE%\Documents\Revit_MCP\GeminiCLI\temp_create_4_walls_v2.py \
    %USERPROFILE%\Documents\Revit_MCP\GeminiCLI\created_4_walls_v2.json \
    %USERPROFILE%\Documents\Revit_MCP\GeminiCLI\temp_create_walls_level_to_level.py \
    %USERPROFILE%\Documents\Revit_MCP\GeminiCLI\created_walls_level_to_level.json \
    %USERPROFILE%\Documents\Revit_MCP\GeminiCLI\temp_offset_walls_level_to_level.py \
    %USERPROFILE%\Documents\Revit_MCP\GeminiCLI\temp_create_dimension_between_walls_level_to_level.py
```
