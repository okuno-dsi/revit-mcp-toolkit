...
```bash
python Python/Manuals/Scripts/send_revit_command_durable.py --port 5211 --command change_structural_column_type --params "{"elementId": 901, "typeId": 802}"
```

**Unique IDを使用する場合（推奨）:**
```bash
python Python/Manuals/Scripts/send_revit_command_durable.py --port 5211 --command change_structural_column_type --params "{"uniqueId": "element-unique-id-string", "typeUniqueId": "type-unique-id-string"}"
```
