...
````powershell
python "%USERPROFILE%\Documents\Revit_MCP\Source\Codex\Manuals\Scripts\cache_revit_info.py" `
  --proxy http://127.0.0.1:5221 `
  --revit-port 5211 `
  --out-dir "%USERPROFILE%\Documents\Revit_MCP\Source\Codex\Manuals\Logs" `
...
````powershell
pwsh -File "%USERPROFILE%\Documents\Revit_MCP\Source\Codex\Manuals\Scripts\get_project_and_documents_cached.ps1" `
  -Port 5211 `
  -Proxy http://127.0.0.1:5221 `
  -OutDir "%USERPROFILE%\Documents\Revit_MCP\Source\Codex\Manuals\Logs"
````
