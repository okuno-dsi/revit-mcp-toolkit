...
**実行コマンド:**
```bash
python Python/Scripts/Reference/send_revit_command_durable.py --port 5210 --command get_selected_element_ids
```
...
**実行コマンド:**
```bash
python Python/Scripts/Reference/send_revit_command_durable.py --port 5210 --command get_element_info --params "{\"elementIds\": [279657, 279659]}"
```
