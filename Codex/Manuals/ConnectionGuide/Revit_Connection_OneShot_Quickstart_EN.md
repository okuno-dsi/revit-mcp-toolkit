...
````powershell
dotnet run --project "%USERPROFILE%\Documents\Revit_MCP\Source\McpPlaybookServer\src\McpPlaybookServer" -- --port 5209 --forward http://127.0.0.1:5210
````
...
````powershell
Set-Location "%USERPROFILE%\Documents\Revit_MCP\Source\ChatRevit"
...
````powershell
python "%USERPROFILE%\Documents\Revit_MCP\Source\Codex\Manuals\Scripts\cache_revit_info.py" --proxy http://127.0.0.1:5221 --revit-port 5211 --out-dir "%USERPROFILE%\Documents\Revit_MCP\Source\Codex\Manuals\Logs" --ttl-sec 0
````

- Use cached data (concise summary):

````powershell
powershell -File "%USERPROFILE%\Documents\Revit_MCP\Source\Codex\Manuals\Scripts\get_project_and_documents_cached.ps1" -Port 5211 -Proxy http://127.0.0.1:5221 -OutDir "%USERPROFILE%\Documents\Revit_MCP\Source\Codex\Manuals\Logs"
````
