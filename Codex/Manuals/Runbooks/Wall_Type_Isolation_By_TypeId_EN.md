...
- Script: `Codex/Scripts/Reference/isolate_single_wall_type_safe.ps1`
- What it does:
...
pwsh -ExecutionPolicy Bypass -File Codex/Scripts/Reference/isolate_single_wall_type_safe.ps1 -Port 5210 -Activate

# Or specify an explicit TypeId
pwsh -ExecutionPolicy Bypass -File Codex/Scripts/Reference/isolate_single_wall_type_safe.ps1 -Port 5210 -TypeId 403 -Activate
```
...
- Script: `Codex/Scripts/Reference/create_seed_and_type_views_typeid.ps1`
- What it does:
...
pwsh -ExecutionPolicy Bypass -File Codex/Scripts/Reference/create_seed_and_type_views_typeid.ps1 -Port 5210

# Reuse previously created views when present (no delete)
pwsh -ExecutionPolicy Bypass -File Codex/Scripts/Reference/create_seed_and_type_views_typeid.ps1 -Port 5210 -ReuseExisting
```
