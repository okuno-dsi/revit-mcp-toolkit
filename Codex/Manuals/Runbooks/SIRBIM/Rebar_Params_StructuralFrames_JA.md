...
元データ（自動出力）:
- `Scripts/Reference/dump_structural_frame_type_param_definitions.py`

### 注釈（note）を維持したまま再出力する
```powershell
python Scripts/Reference/dump_structural_frame_type_param_definitions.py --port 5210 --include-values --annotation-csv Manuals/Runbooks/SIRBIM/structural_frame_type_parameters_with_values_SIRBIM_annotated.csv
```
