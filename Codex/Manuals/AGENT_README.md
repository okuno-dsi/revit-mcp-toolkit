...
- Source-of-truth repo: keep the working master under `C:\Users\<user>\Documents\Revit_MCP` (or your designated Git working copy).  
  Keep rescue/reference copies separate, and never overwrite the master without an explicit diff review.
