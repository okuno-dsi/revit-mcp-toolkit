...
```
python Scripts/Reference/send_revit_command_durable.py --port 5210 --command rename_types_bulk \
  --params '{
    "items": [
...
```
pwsh -ExecutionPolicy Bypass -File Scripts/Reference/rename_types_bulk.ps1 -Port 5210 \
  -CsvPath Projects/YourProject_5210/Logs/type_renames.csv -ConflictPolicy skip
```
