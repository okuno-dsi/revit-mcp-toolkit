...
pwsh -File Codex/Scripts/Reference/export_walls_by_type_snapshot.ps1 -Port 5210 `
  -ProjectDir "%USERPROFILE%\Documents\Revit_MCP\Source\Codex\Projects\\Project_5211_20251021_125656" `
...
python Tools/AutoCad/merge_dwgs_by_map_com.py \
  --source-dir "%USERPROFILE%\Documents\Revit_MCP\Source\Codex\Projects\\dwg" \
  --out-dwg "%USERPROFILE%\Documents\Revit_MCP\Source\Codex\Projects\\dwg\MERGED_DWG_COM.dwg" \
  --map-csv "%USERPROFILE%\Documents\Revit_MCP\Source\Codex\Projects\\dwg\layermap.csv"
```
...
pwsh -File Codex/Scripts/Reference/merge_bg_from_seed.ps1 \
  -ExportDir "%USERPROFILE%\Documents\Revit_MCP\Source\Codex\Projects\\AutoCadOut\Export_20251102_134250" \
  -Locale ja-JP
```
...
pwsh -File Codex/Scripts/Reference/list_dwg_layers_coreconsole.ps1 \
  -DwgPath "%USERPROFILE%\Documents\Revit_MCP\Source\Codex\Projects\\AutoCadOut\Export_20251102_134250\Merged_B_G.dwg" \
  -Locale ja-JP
```
