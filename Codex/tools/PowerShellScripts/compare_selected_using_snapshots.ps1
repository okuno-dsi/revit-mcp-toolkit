# @feature: compare selected using snapshots | keywords: スペース, スナップショット
param(
  [string]$LeftSnapshot,
...
$outJ = Join-Path $ROOT ("Projects/compare_selected_pair_"+$ts+".json")
$outC = Join-Path $ROOT ("Projects/compare_selected_pair_"+$ts+".csv")
