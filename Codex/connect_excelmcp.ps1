...
param(
  [string]$BaseUrl,
  [int]$Port,
  [string]$ExePath = '%USERPROFILE%\Documents\Revit_MCP\Source\ExcelMCP\bin\x64\Release\net8.0-windows\ExcelMCP.exe',
  [switch]$OnlyCheck,
  [switch]$NoStart
)
...
.DESCRIPTION
  ...
  ExcelMCP such as:
    - Codex/Scripts/Reference/apply_from_excelmcp.ps1
    - Codex/Scripts/Reference/place_rooms_from_excel_labels.ps1
