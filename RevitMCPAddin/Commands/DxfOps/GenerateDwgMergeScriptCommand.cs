// RevitMCPAddin/Commands/DxfOps/GenerateDwgMergeScriptCommand.cs
#nullable enable
    ...
    public class GenerateDwgMergeScriptCommand : IRevitCommandHandler
    {
        ...
        public object Execute(UIApplication uiapp, RequestCommand cmd)
        {
            try
            {
                ...
                string bindType = (p.Value<string>("bindType") ?? "Bind").Trim();
                string refPathType = (p.Value<string>("refPathType") ?? "2").Trim();
                ...
                string mergeMode = (p.Value<string>("mergeMode") ?? "None").Trim();
